...
%Adams_Bashforth
beta=1;
[u1,t]=Adams_Bashforth(@dfa,tf,t0,N,u0,beta);

 plot(u1(1,:), u1(2,:)); hold all
%  
%  beta=[-1/2, 3/2];
%  [u2,t]=Adams_Bashforth(@dfa,tf,t0,N,u0,beta);
% 
%  plot(u2(1,:), u2(2,:)); hold all
%  
%   beta=[5/12, -16/12, 23/12];
%  [u3,t]=Adams_Bashforth(@dfa,tf,t0,N,u0,beta);
% 
%  plot(u3(1,:), u3(2,:)); hold all
%  
%   beta=[-9/24 37/24 -59/24 55/24];
%  [u4,t]=Adams_Bashforth(@dfa,tf,t0,N,u0,beta);
% 
